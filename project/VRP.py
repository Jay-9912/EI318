...
class VRP():
    ...
    def input_demand_and_car_num(self,demand_list,car_num,first_place,robot_index,robot):
    ...
    def exchange_and_relocate(self,action_num):
            ...
            while (leagal_flag == 0):
                ...
                if (rand1 == rand2 and abs(rand3 - rand4) <= 1 ) or (self.check_capacity_leagal(rand1, rand2, rand3, rand4)==0):
                    continue
            ...
            for i in range(action_num):
                ...
                while (leagal_flag == 0):
                    ...
                    if (rand1 == rand2 and abs(rand3 - rand4) <= 1)  or len(new_route[rand1])==3 :
                        continue
...
# ton = 100
#
# vrp = VRP(place_num=16,ton=ton)
# vrp.input_demand_and_car_num(demand_list=demand,car_num=2,first_place= [],robot_index = [],robot=[1,3])
# a,b,c = vrp.cal_everything()
# print(a)
# print(b)
# print(c)
# print(vrp.Routes)
